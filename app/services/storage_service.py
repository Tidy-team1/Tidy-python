...
from app.utils.s3_key_builder import pptx_key_for_version
...
def download_presentation(space_id: int, presentation_id: int, version: int) -> str:
    # version 기반으로 S3 key 생성
    s3_key = pptx_key_for_version(space_id, presentation_id, version)
